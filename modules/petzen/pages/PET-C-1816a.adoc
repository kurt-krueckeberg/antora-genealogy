...
Quadsimodogeniti (the 1^st^ Sunday After Easter), appears on <<PET-C-1816a,
image 211>>, on page 446, entry 16, of the "Verzeichnis der Getauften,
...
* [[[PET-C-1816a]]] "Archion Protestant Kirchenbücher Portal", database with images, _Archion_
