...
The baptism entry is found on <<PET-B-1736a, image 152>>. It is the third entry from the top
...
[IMPORTANT]
====
* *Berenbusch* is not mentioned explicitly. It is assumed image:img152-abbrev.jpg[] is
...
[NOTE]
====
* If the two characters following "v. [von=of, from]" are two B's, they likely are abbreviations
for Berenbusch. 
...
[[PET-B-1736a]]
* [[[PET-B-1736a]]] "Archion Protestant Kirchenbücher Portal", database with images, _Archion_ (https://www.archion.de/p/07af317ee9/ : 09 May 2025),
