...
The image below excerpts the three burial entries for 14 February 1734.

image::petzen-band1b-img150.png[title=14 Feb, 1734 Krückeberg Töchterlein buried (Click to Enlarge),link=self]

== Citation

These 1734 burial records are on <<image150, image 150>> of the Petzen Kirchenbuch " Verzeichnis der Getauften und
...
* [[[image150]]] "Archion Protestant Kirchenbücher Portal", database with images,
:https://www.archion.de/p/55dfeb492a/ : 13 Nov. 2025), path: Niedersachsen > Niedersächsisches Landesarchiv >
