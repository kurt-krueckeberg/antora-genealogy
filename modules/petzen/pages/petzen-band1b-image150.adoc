...
stylistics preference of that period used instead of Sohn and Tochter, which
later become the norm. It was understood since infant baptism was practiced that the
...
Krückeberg from Berenbusch. The pastor does not give her personal name. He 
does not given the personal name.
...
alone. Therefore, the possible baptim record should be looked for.
