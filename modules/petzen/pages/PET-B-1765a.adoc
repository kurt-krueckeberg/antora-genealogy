...
[IMPORTANT]
====
While the mother's name is not given on the baptism record, the male baptismal sponsor is *Rösener*, and
on 29 Sep. 1758, *Ilse Margarethe Rösener* from Evesen married Johann Heinrich Krückeberg from Berenbusch
as their xref:petzen:PET-M-1758a.adoc[] record shows.
====
