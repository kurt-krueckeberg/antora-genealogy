...
working operation of the farm to a successor (usually a son) but continues
...
The death of Johann Heinrich Krückeberg Death in 1822 is found on <<PET-D-1822a, image 313, on pages 652 and 652>> of Petzen Kirchenbuch volume
...
====
_Leibzüchter_  is an unusual word. It has only occurred in one other record of interest: the xref:PET-M-1790e.adoc[marriage of Anna Marie Weiland in 1791 to Heinrich Tellermann]. It is defined in Ernest Thode's _German English
...
|===
|Zahl |Name, Stand, Religion, Gewerbe, Geburts u. bisheriger Wohnort des Vestorbene |Zeit u. Ort des Todes u. des Begräbenises |Ursaches Todes |Alter |Ledig oder verheÿrathet |Hinterbliebende |Bemerkerungen
