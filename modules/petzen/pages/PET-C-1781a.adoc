...
This confirmation entry is on the <<PET-C-1781a, 320th image on Archion>> of Petzen Kirchenbuch "database with images".
...
with images, _Archion_ (http://www.archion.de/p/24d49d81bd/: 29 October
