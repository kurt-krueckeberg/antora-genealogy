...
In 1804 Fridrich Wilhem Weyland married Caroline Luise Lauen and Fridrich
Weyland married Catharine Margaretha Drinkuth.

== Citation

The marriage is found on <<PET-M-1804a,image 13, page 20, entry 3,>> of the
Petzen Kirchenbuch volume "Verzeichnis der Getauften, Konfirmierten,
