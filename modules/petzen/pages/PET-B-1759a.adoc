...
The baptism of Ilse Margaretha Krückeberg is on <<PET-B-1759a, image 200,
right page, first entry>> from the  "database with images (Register of
...
with images, _Archion_ (https://www.archion.de/p/aeb69c46c5/ : 2 November
