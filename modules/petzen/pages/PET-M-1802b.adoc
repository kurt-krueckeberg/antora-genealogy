...
|*Bride*|Philippine Doroth[ea] Beucken| [?] by him several years ago|Evesen|Einliegerin
|===

.What Leibzüchter tells us
****
[IMPORTANT]
====
...
* He retained residence and livelihood rights (_Leibzucht_)
...
The marriage occurred on April 11, 1802. It is <<PET-M-1802b, entry 10,
page 19, on image 12>> of Petzen Kirchenbuch Verzeichnis der Getauften,
...
[IMPORTANT]
====
The word "geschwächt" is ambigous, but it does resemble in its wording
another marriage record were *geschwägt* is clearly, that of
xref:petzen:PET-M-1804a.adoc[]. While is "geschächt" means
"weakened", the sense is idomatic. It refers to premartial sexual
relations.
====
...
|===
|Zahl |Namen des Bräutigams |Ortschaft|Sh|Namen der Braut|Ortschaft|No:
...
[%header,cols="1,7,3,1,7,3,1",frame="none"]
|===
|Num |Name of Groom |Village| [uncertain?] |Name of Bride | Village | N.:
...
with images, _Archion_ (http://www.archion.de/p/670cfbbaf6/ : 22
