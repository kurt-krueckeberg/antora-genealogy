...
The baptism record for Anna Ilse Blecken appears on <<image247, image
247>>, on the right-hand page, entry #43, the third entry from the top, of
...
* [[[PET-B-1775c]]] "Archion Protestant Kirchenbücher Portal", database with images, _Archion_ (https://www.archion.de/p/476ca0655c/
