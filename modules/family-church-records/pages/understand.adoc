...
pass:[<span style="font-family: 'Wiegel Kurrent Medium'; font-size: 1.7em;">R</span>] and pass:[<span style="font-family: 'Wiegel Kurrent
Medium'; font-size: 2em;">K </span>]
 ...
 * The embellished Gothic `d` (ending in an elaborate descending inward
loop) often appears immediately after the line number and preceding a
date.
