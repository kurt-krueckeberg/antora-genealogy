...
| xref:petzen:PET-M-1727a.adoc[1727 marriage] “aus Berenbusch”  
| Krückeberg lived in the village           

| xref:petzen:PET-B-1728a.adoc[1728 baptism sponsor]: Eggerding 
| Social link to the earlier holder +
Eggerding -> Kuhlmann -> Krückeberg

| xref:nla:2728:survey-1737.adoc[1737 Hausbesitzer list]
| Krückeberg might not yet be holder (unclear)             

| xref:nla:2741:index.adoc[1743–44 questionnaire]
| Krückeberg is holder; predecessors named  +
Eggerding -> Kuhlmann -> Krückeberg
 
| xref:nla:2713:index.adoc[1745 survey]
| Krückeberg confirmed as holder            

| xref:nla:140:page-17.adoc[1747 list]
