...
The baptism record is on <<image9, image 9, pages ??>>, of the Windheim Kirchenbuch Volume 5G: _Taufen 1816-1836,
...
NOTE: I believe--though I'm not certain, since the header does not denote this--that the "fourth" written above the
