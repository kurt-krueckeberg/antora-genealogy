...
The birth record for Heinrich Friedrich August Krückeberg of Thüste is found on <<WAL-B-1822a, image 114>> of the Wallensen parishs church register volume for the
...
* [[[WAL-B-1822a]]] "Archion Protestant Kirchenbücher Portal", database with images, _Archion_ (http://www.archion.de/p/de0cff4510/ : 26 October 2023), path: path: Niedersachsen > 
