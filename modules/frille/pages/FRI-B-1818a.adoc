...
[%header,cols="1l,4l,4l,2l,4l,4l,3l,2l,3l,5l"]
|===
|Nro.|Tauf-Name +
des Kindes.|Tag und Stunde +
der Geburt +
in +
Buchstaben und Ziffern. |Ob es +
ehelich +
oder +
unehelich.|Vor- and Zuname +
des Vaters, +
auch Stand desselben|Vor- und Zuname +
der +
Mutter.|Wohnort +
der +
Eltern |Tag +
der +
Taufe.|Namen des Predigers, +
der es getauft.|Name der Taufzeugen
